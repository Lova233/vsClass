  ...
  */
  let singleClass = vscode.commands.registerCommand(
    ...
    () => {
      ...
      const selection = Service.getSelectedElement()

      //Transform the selection in cssContent
      const cssContent = Service.getCssContent(selection, isSingle)
  ...
  */
  let allClass = vscode.commands.registerCommand(
    ...
    () => {
      ...
      //Grab the selection and convert it to style content may be splitted in 2 functions
      let selection = Service.getSelectedElement();

      //Transform the selection in cssContent
      const cssContent = Service.getCssContent(selection, isSingle, regexClass, 1)
